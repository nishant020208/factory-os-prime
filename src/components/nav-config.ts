...
import {
  ...
  ScrollText, Landmark, UserRound, FileCheck2, Building2, TreePine, Layers3,
  Calendar, Gauge, ArrowLeftRight, PackageCheck, PackageOpen, ClipboardCheck,
...
export const NAV_BY_ROLE: Record<AppRole, NavSection[]> = {
  ...
  production_manager: [
    ...
    { label: "Reports", items: [
      { to: "/production-reports", label: "Production Reports", icon: ClipboardList },
    ]},
  ],
  ...
  quality_inspector: [
    ...
    { label: "Reports", items: [
      { to: "/quality-reports", label: "Quality Reports", icon: ClipboardList },
    ]},
  ],
  ...
  maintenance_engineer: [
    ...
    { label: "Reports", items: [
      { to: "/maintenance-reports", label: "Reports", icon: ClipboardList },
    ]},
  ],
