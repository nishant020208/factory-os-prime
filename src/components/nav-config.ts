...
export const NAV_BY_ROLE: Record<AppRole, NavSection[]> = {
  ...
  plant_manager: [
    ...
    },
    {
      ...
      items: [
        { to: "/production", label: "Production Schedule", icon: Calendar },
        { to: "/work-orders", label: "Work Orders (View)", icon: ListTodo },
        { to: "/attendance", label: "Staff Attendance", icon: Timer },
        { to: "/machines", label: "Machine Status", icon: Cog },
        { to: "/warehouse", label: "Warehouse", icon: Warehouse },
        { to: "/maintenance", label: "Maintenance", icon: Wrench },
        { to: "/quality", label: "Quality", icon: ShieldCheck },
      ],
  ...
  finance_manager: [
    {
      ...
      items: [
        ...
        { to: "/payments", label: "Payments Received", icon: DollarSign },
        { to: "/supplier-payments", label: "Supplier Payments", icon: Wallet },
        { to: "/customer-ledger", label: "Customer Ledger", icon: Users },
        { to: "/expenses", label: "Expenses", icon: PiggyBank },
        { to: "/taxes", label: "GST / Tax", icon: FileText },
  ...
  supplier_portal: [
    {
      ...
      items: [
        ...
        { to: "/my-catalog", label: "Raw Materials", icon: Package },
