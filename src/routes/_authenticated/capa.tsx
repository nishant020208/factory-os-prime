...
export const Route = createFileRoute("/_authenticated/capa")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Corrective and Preventive Actions tracking and management.",
      },
    ],
  }),
  component: CAPAPage,
...
const CAPAS = [
  {
    id: "CAPA-2026-001",
    title: "Weld porosity on Al Housing batch",
    root_cause: "Shielding gas flow rate below spec",
    type: "Corrective",
    status: "completed",
    due: "2026-06-15",
    owner: "Sarah Chen",
  ...
  {
    id: "CAPA-2026-002",
    title: "Dimensional drift on Ti Brackets",
    root_cause: "Tool wear beyond replacement interval",
    type: "Corrective",
    status: "in_progress",
    due: "2026-07-30",
    owner: "James Miller",
  ...
  {
    id: "CAPA-2026-003",
    title: "Prevent coolant contamination",
    root_cause: "Preventive — no incident yet",
    type: "Preventive",
    status: "planned",
    due: "2026-08-15",
    owner: "Mike Johnson",
  ...
  {
    id: "CAPA-2026-004",
    title: "Solder joint anomaly on CB-X1",
    root_cause: "Reflow profile needs optimization",
    type: "Corrective",
    status: "in_progress",
    due: "2026-07-15",
    owner: "Lisa Wang",
  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      ...
      <PageHeader
        eyebrow="Quality"
        title="CAPA"
        sub="Corrective and Preventive Actions — root cause analysis and resolution tracking."
        actions={
          <>
            <Button
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs px-2 py-0.5 rounded-full border border-white/10 bg-muted/50">
                        {c.type}
                      </span>
                    </div>
