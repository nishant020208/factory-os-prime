...
const reports = [
  {
    g: "Manufacturing",
    items: ["Production Output", "Work Order History", "Scrap & Rework", "OEE Breakdown"],
  },
  {
    g: "Inventory",
    items: ["Stock Aging", "Reorder Report", "ABC Analysis", "Cycle Count Variance"],
  },
  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      ...
      <PageHeader
        ...
        sub="Every operational and financial report in PDF, Excel and CSV."
