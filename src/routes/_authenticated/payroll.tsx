              ...
              <tbody>
                {payrollRecords.map((r) => (
                  <tr key={r.id} className="border-b border-white/5 hover:bg-white/[0.02]">
                    ...
                    <td className="py-2.5 px-2 text-right tabular-nums font-mono text-xs hidden md:table-cell">
                      {r.overtime > 0 ? `$${r.overtime.toLocaleString()}` : "—"}
                    </td>
