  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      <PageHeader
        eyebrow="People"
        title="Performance"
        sub="Employee performance reviews, KPIs and goal tracking."
        actions={
          <Button
        ...
        <DialogContent className="sm:max-w-[420px]">
          ...
          <DialogFooter>
            <Button
              ...
              disabled={!empName || createMutation.isPending}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <Kpi
          ...
          value={`${totalAchieved}/${totalGoals}`}
          icon={Target}
          tone="success"
        />
                    ...
                    <td className="py-2.5 px-2">
                      <div className="flex items-center gap-2">
                        <div className="w-16 h-1.5 rounded-full bg-white/5 overflow-hidden">
                          <div
                            className={`h-full rounded-full ${r.score >= 90 ? "bg-success" : r.score >= 80 ? "bg-info" : "bg-warning"}`}
                            style={{ width: `${r.score}%` }}
                          />
                        </div>
