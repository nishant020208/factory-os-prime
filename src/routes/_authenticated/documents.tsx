  ...
  head: () => ({
    meta: [
      { title: "Documents — FactoryOS AI" },
      {
        name: "description",
        content:
          "SOPs, manuals, policies, delivery notes and shared documents with customer upload support.",
      },
    ],
  }),
  ...
  return (
    <div className="max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        <Kpi
          label="Categories"
          value={String(new Set(data?.map((d: any) => d.category).filter(Boolean)).size)}
        ...
        <DialogContent className="sm:max-w-[480px]">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <div
                className="border-2 border-dashed border-white/10 rounded-lg p-6 text-center hover:border-primary/30 transition cursor-pointer"
