...
const opt = (...v: string[]): FieldOption[] =>
  v.map((x) => ({
    value: x,
    label: x.replace(/_/g, " ").replace(/\b\w/g, (c) => c.toUpperCase()),
  }));
...
const PRIORITY: FieldDef = {
  ...
  type: "select",
  required: true,
  options: opt("low", "medium", "high", "critical"),
  defaultValue: "medium",
};
...
export const MODULE_FIELDS: Record<string, FieldDef[]> = {
  ...
  "/maintenance": [
    ...
    PRIORITY,
    {
      ...
      type: "select",
      required: true,
      options: opt("open", "in_progress", "resolved"),
      defaultValue: "open",
    },
  ],
  "/breakdowns": [
  ...
  "/schedules": [
    ...
    },
    {
      ...
      type: "select",
      required: true,
      options: opt("weekly", "monthly", "quarterly"),
  ...
  "/taxes": [
    ...
    { key: "amount", label: "Amount", type: "number", required: true },
    {
      ...
      type: "select",
      required: true,
      options: opt("pending", "filed", "paid"),
  ...
  "/leaves": [
    ...
    { key: "end_date", label: "End Date", type: "date", required: true },
    {
      ...
      type: "select",
      required: true,
      options: opt("casual", "sick", "earned", "unpaid"),
      defaultValue: "casual",
    },
  ...
  "/recruitment": [
    ...
    { key: "openings", label: "Openings", type: "number", required: true, defaultValue: "1" },
    {
      ...
      type: "select",
      required: true,
      options: opt("open", "on_hold", "closed"),
      defaultValue: "open",
    },
    { key: "description", label: "Description", type: "textarea" },
  ],
  "/training": [
    ...
    { key: "completion_date", label: "Completion Date", type: "date" },
    {
      ...
      type: "select",
      required: true,
      options: opt("assigned", "in_progress", "completed"),
  ...
  "/attendance": [
    ...
    { key: "check_out", label: "Check Out", type: "datetime" },
    {
      ...
      type: "select",
      required: true,
      options: opt("present", "absent", "leave", "half_day"),
  ...
  "/warehouse": [
    ...
    { key: "plant_id", label: "Plant", type: "ref", ref: { table: "plants", labelColumn: "name" } },
  ],
  "/transfers": [
    {
  ...
  "/receiving": [
    {
      ...
      ref: {
        ...
        filterIn: { column: "status", values: ["accepted", "sent"] },
      },
    },
    {
      key: "material_id",
  ...
  "/quality": [
    ...
    },
    {
      ...
      type: "select",
      required: true,
      options: opt("incoming", "in_process", "final"),
      defaultValue: "final",
    },
    {
      key: "result",
  ...
  "/compliance": [
    ...
    { key: "standard", label: "Standard", type: "text", placeholder: "e.g. ISO 9001" },
    {
      ...
      type: "select",
      required: true,
      options: opt("compliant", "at_risk", "expired"),
