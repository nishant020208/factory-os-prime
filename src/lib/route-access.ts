...
export const ROUTE_ACCESS: Record<string, AppRole[]> = {
  ...
  "/attendance": ONLY("company_admin", "hr_manager", "plant_manager", "auditor"),
  ...
  "/warehouse": ONLY("company_admin", "plant_admin", "plant_manager", "warehouse_manager", "auditor"),
  ...
  "/products": ONLY("company_admin", "plant_admin", "production_manager", "warehouse_manager", "auditor"),
  ...
  "/maintenance": ONLY("company_admin", "plant_admin", "plant_manager", "maintenance_engineer", "auditor"),
