...
const es: Dict = {
  ...
  "Plant Overview": "Vista de Planta",
  ...
  Receiving: "Recepción",
  Dispatch: "Envío",
  "Cycle Count": "Recuento Cíclico",
  "Purchase Requests": "Solicitudes de Compra",
  "Purchase Orders": "Órdenes de Compra",
  RFQ: "Solicitud de Cotización",
  "Vendor Comparison": "Comparación de Proveedores",
  "Goods Receipt": "Recepción de Bienes",
  "Incoming Inspection": "Inspección de Entrada",
  "In-Process Inspection": "Inspección en Proceso",
  "Final Inspection": "Inspección Final",
  Defects: "Defectos",
  CAPA: "CAPA",
  Schedules: "Horarios",
  "Machine History": "Historial de Máquinas",
  Breakdowns: "Averías",
...
const de: Dict = {
  ...
  "Order Approvals": "Auftragsfreigaben",
  ...
  "Knowledge Center": "Wissenszentrum",
  Settings: "Einstellungen",
  "Plant Overview": "Werksübersicht",
  "Plant Performance": "Werksleistung",
  "Approved Orders": "Freigegebene Aufträge",
  ...
  RFQ: "Angebotsanfrage",
  "Vendor Comparison": "Lieferantenvergleich",
  "Goods Receipt": "Wareneingang",
  "Incoming Inspection": "Wareneingangsprüfung",
  "In-Process Inspection": "Prozessprüfung",
  "Final Inspection": "Endprüfung",
  Defects: "Defekte",
  CAPA: "CAPA",
  Schedules: "Zeitpläne",
  "Machine History": "Maschinenhistorie",
  Breakdowns: "Ausfälle",
  ...
  Tasks: "Aufgaben",
  "Production Logs": "Produktionsprotokolle",
  "Report Issue": "Problem melden",
  "My Machines": "Meine Maschinen",
  Orders: "Aufträge",
  Shipments: "Sendungen",
  Support: "Support",
  Documents: "Dokumente",
...
const ja: Dict = {
  ...
  Plants: "工場",
  Departments: "部門",
  "Order Approvals": "注文承認",
  "Customer Requests": "顧客リクエスト",
  Materials: "資材",
  Employees: "従業員",
  Roles: "役割",
  Whitelist: "ホワイトリスト",
  ...
  Settings: "設定",
  "Plant Overview": "工場概要",
  "Plant Performance": "工場パフォーマンス",
  "Approved Orders": "承認済み注文",
  ...
  Dispatch: "出荷",
  "Cycle Count": "循環棚卸",
  "Purchase Requests": "購買依頼",
  "Purchase Orders": "発注書",
  RFQ: "見積依頼",
  "Vendor Comparison": "ベンダー比較",
  "Goods Receipt": "入荷",
...
const hi: Dict = {
  ...
  Plants: "प्लांट्स",
  Departments: "विभाग",
  "Order Approvals": "ऑर्डर अनुमोदन",
  "Customer Requests": "ग्राहक अनुरोध",
  Materials: "सामग्री",
  Employees: "कर्मचारी",
  Roles: "भूमिकाएँ",
  ...
  Settings: "सेटिंग्स",
  "Plant Overview": "प्लांट अवलोकन",
  "Plant Performance": "प्लांट प्रदर्शन",
  "Approved Orders": "स्वीकृत ऑर्डर",
  ...
  Warehouses: "गोदाम",
  "Stock Movement": "स्टॉक संचलन",
  Transfers: "स्थानांतरण",
  Receiving: "प्राप्ति",
  Dispatch: "प्रेषण",
  "Cycle Count": "चक्र गणना",
  "Purchase Requests": "खरीद अनुरोध",
  "Purchase Orders": "खरीद आदेश",
  RFQ: "आरएफक्यू",
  "Vendor Comparison": "विक्रेता तुलना",
  "Goods Receipt": "माल प्राप्ति",
  "Incoming Inspection": "आवक निरीक्षण",
  "In-Process Inspection": "प्रक्रिया निरीक्षण",
  "Final Inspection": "अंतिम निरीक्षण",
  Defects: "दोष",
  CAPA: "कापा",
  Schedules: "अनुसूची",
  "Machine History": "मशीन इतिहास",
  ...
  Tasks: "कार्य",
  "Production Logs": "उत्पादन लॉग",
  "Report Issue": "समस्या रिपोर्ट करें",
  "My Machines": "मेरी मशीनें",
  Orders: "ऑर्डर",
  Shipments: "शिपमेंट",
  Support: "सहायता",
  Documents: "दस्तावेज़",
