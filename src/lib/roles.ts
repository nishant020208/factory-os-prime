...
export const ROLES: RoleMeta[] = [
  ...
  },
  {
    id: "company_admin",
    label: "Company Admin",
    tagline: "Multi-plant tenant admin",
    icon: Building2,
  ...
  },
  {
    id: "plant_manager",
    label: "Plant Manager",
    tagline: "Runs day-to-day plant ops",
    icon: ClipboardList,
